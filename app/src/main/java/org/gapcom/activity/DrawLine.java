...
public class DrawLine extends AppCompatActivity {
    ...
    public Polyline drawLine(View view){
        ...
        latLngs.add(new LatLng(35.750888, 51.445589));
        latLngs.add(new LatLng(35.759142, 51.438078));
        latLngs.add(new LatLng(35.758167, 51.447048));
        latLngs.add(new LatLng(35.732407, 51.445085));
        latLngs.add(new LatLng(35.757454, 51.478625));
        ...
        map.moveCamera(new LatLng(35.750888, 51.445589),0.25f );
        map.setZoom(14,0);
        return polyline;
    }
