...
import org.gapcom.servicessdk.direction.NeshanDirection;
import org.gapcom.servicessdk.direction.model.DirectionStep;
import org.gapcom.servicessdk.direction.model.NeshanDirectionResult;
import org.gapcom.servicessdk.direction.model.Route;
...
public class Routing extends AppCompatActivity {
    ...
    private void initMap() {
        ...
        map.moveCamera(new LatLng(35.758653,51.442734), 2);
        map.setZoom(14, 0);
    }
    ...
    private void neshanRoutingApi() {
        ...
        //waypoints.add(markers.get(2).getLatLng());


        new NeshanDirection.Builder("service.2ZYotexOaeD4OFPqpTI0acluQpbmqh0m0IZC7cbG", markers.get(0).getLatLng(), markers.get(1).getLatLng(),waypoints)
            ...
            public void onResponse(Call<NeshanDirectionResult> call, Response<NeshanDirectionResult> response) {
                ...
                for (DirectionStep step : route.getLegs().get(0).getDirectionSteps()) {
                    ...
                    System.out.println("route==========" + step.getName() + " - " + step.getInstruction() + " فاصله  - " + step.getDistance().getText() + " زمان  - " + step.getDuration().getText());
                }
